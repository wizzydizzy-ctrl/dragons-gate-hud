...
MODULES=['defaults','command_parser','command_collector','chat_parser','chat_history','chat_storage','chat_controller','navigation','mapper_model','map_adapter','automapper','state','settings','sha256','release','events','layout','view','mudlet_adapter','main','updater']
