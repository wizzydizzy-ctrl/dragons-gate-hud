...
local function fake(entries)
  local f={next=0,triggers={},storageAppends=0,storageEntries=entries or {},storedCharacters={},errors=0,epochValue=100,timestampValue="2026-08-31T13:00:00-04:00",character="Dace Alterac"}
  ...
  f.storage={}
  function f.storage:loadRecent() return f.storageEntries end
