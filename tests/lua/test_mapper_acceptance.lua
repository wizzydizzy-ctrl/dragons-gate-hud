...
test("mapper release defaults are ready for version 0.2.55",function()
  eq(Defaults.version,"0.2.55"); eq(Defaults.mapper.enabled,true); eq(Defaults.mapper.walk_timeout,12)
