...
test("mapper release defaults are ready after version 0.2.51",function()
  eq(Defaults.version,"0.2.52"); eq(Defaults.mapper.enabled,true); eq(Defaults.mapper.walk_timeout,12)
