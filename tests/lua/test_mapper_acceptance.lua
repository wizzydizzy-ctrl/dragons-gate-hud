...
test("HUD release defaults are ready for version 0.2.110",function()
  eq(Defaults.version,"0.2.110"); eq(Defaults.mapper.enabled,true); eq(Defaults.mapper.walk_timeout,12)
  eq(Defaults.theme.hp,"#ba5147"); eq(Defaults.theme.fatigue,"#e0c94f")
