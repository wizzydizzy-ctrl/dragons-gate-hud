...
test("visible header removes protocol wording",function()
  local h=View.headerContent({mode="wide",body_font=20,heading_font=25},{accent="#d8ae53",jade="#72bd82",text="#fff",muted="#777"},"Test Tester",{real_time="12:41:06 AM",game_time="3:24 AM",period="Night"})
  eq(h:find("GMCP",1,true),nil); eq(h:find("LIVE",1,true),nil); eq(h:find("Real Time:",1,true)~=nil,true); eq(h:find("12:41:06 AM",1,true)~=nil,true); eq(h:find("Game Time:",1,true)~=nil,true); eq(h:find("3:24 AM",1,true)~=nil,true); eq(h:find("Night",1,true)~=nil,true)
end)
test("header clock uses the responsive clock-specific font",function()
  local h=View.headerContent({mode="medium",body_font=16,heading_font=21,header_clock_font=10},{accent="#da5",jade="#7b8",text="#fff",muted="#777"},"Test",{real_time="12:41:06 AM",game_time="3:24 AM",period="Night"})
